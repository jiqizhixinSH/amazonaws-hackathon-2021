...
def do_nms(boxes, nms_thresh):
    """
    perform non-max suppresion of the bounding boxes

    Arguments:
        boxes -- list of bounding boxes
        nms_thresh -- threshold value of non-max suppression
    ...
    for c in range(nb_class):
        sorted_indices = np.argsort([-box.classes[c] for box in boxes]) # sort class probability from high to low
